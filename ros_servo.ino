...
void messageCb0(const std_msgs::Int8& msg){
  ...
  if(msg.data==0){//初始位置
    rosServo[2].write(80);//臂关节
    rosServo[1].write(90);//腕关节
    rosServo[0].write(95);//爪子
    }
  else if(msg.data==1){//预备夹持
    rosServo[2].write(135);//臂关节
    rosServo[1].write(50);//腕关节
    ...
    rosServo[2].write(90);//臂关节
    rosServo[1].write(60);//腕关节
    rosServo[1].write(70);//腕关节
    ...
    //臂关节~135
    rosServo[2].write(95);//臂关节
    rosServo[2].write(100);//臂关节
    rosServo[2].write(110);//臂关节
    rosServo[2].write(120);//臂关节
    rosServo[2].write(130);//臂关节
    rosServo[2].write(135);//臂关节
    rosServo[1].write(50);//腕关节
    rosServo[0].write(45);//爪子
    }
